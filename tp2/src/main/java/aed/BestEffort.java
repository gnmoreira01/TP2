...
public class BestEffort {
    ...
    private Heap<Traslado> heap_pedidos_por_antiguedad;package aed;
...
public class BestEffort {
    ...
    public BestEffort(int cantCiudades, Traslado[] traslados){
        ...
        ArrayList<Traslado> vectorTrasladosII = new ArrayList<Traslado>();
        for (int i = 0; i < traslados.length; i++){
            vectorTraslados.add(traslados[i]);
            vectorTrasladosII.add(traslados[i]);
        ...
        heap_pedidos_por_antiguedad = new Heap <Traslado> (vectorTrasladosII,1);
